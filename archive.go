...
// Set replaces or adds a file with the given name and data to the archive.
// If multiple files with the same name exist, all are removed before adding the new one.
